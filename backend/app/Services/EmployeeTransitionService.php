...
class EmployeeTransitionService
{
    ...
    /**
     * Execute individual employee transitions with workstation-based assignment.
     *
     ...
     *
     * @param  array<int, array{employee_id: int, to_branch_id: int, to_position_id: int|null, to_workstation_ids?: array}>  $transitions
