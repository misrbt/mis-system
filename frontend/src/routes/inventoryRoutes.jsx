...
const WorkstationListPage = lazy(() => import('../pages/inventory/WorkstationListPage'))
...
const inventoryRoutes = {
  ...
  children: [
    ...
    {
      path: 'workstations',
      element: <WorkstationListPage />,
    },
    {
      path: 'employee-transitions',
      element: <EmployeeTransitionsPage />,
    },
    {
      path: 'statuses',
      element: <StatusPage />,
