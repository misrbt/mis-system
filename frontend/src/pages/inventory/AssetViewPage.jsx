...
function AssetViewPage() {
  ...
  const employeeAssets = Array.isArray(employeeAssetsData?.data)
    ? employeeAssetsData.data
    : [];
    ...
    return (
      <>
        ...
        <IndividualAssetView
          ...
          navigateToEmployeeAssets={(empId) =>
    ...
    return (
      <div className="min-h-screen pb-8 bg-gray-50">
        {codeModal &&
          createPortal(
            <div
              className="fixed inset-0 z-50 flex items-center justify-center px-4 transition-opacity duration-200 bg-black/60"
              onClick={() => setCodeModal(null)}
            >
              <div
                className="w-full max-w-3xl overflow-hidden transition-all duration-200 bg-white shadow-2xl rounded-xl"
              ...
              >
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
                  ...
                  <button
                    onClick={() => setCodeModal(null)}
                    className="p-2 transition-colors duration-200 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100"
                    aria-label="Close"
                  >
                    <X className="w-5 h-5" />
                  </button>
        ...
        <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
          <div className="px-4 py-3 mx-auto max-w-7xl sm:px-6 lg:px-8 sm:py-4">
            ...
            <div className="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center min-w-0 gap-3 sm:gap-4">
                ...
                <div className="min-w-0">
                  <h1 className="text-lg font-bold leading-snug text-gray-900 break-words sm:text-2xl">
              ...
              {/* Quick Actions */}
              <div className="flex flex-wrap items-center justify-start w-full gap-2 sm:justify-end sm:w-auto">
                <div className="relative">
                  <button
                    onClick={() =>
                      setStatusPickerFor(
                        statusPickerFor === asset.id ? null : asset.id
                      )
                    }
                    className="inline-flex items-center gap-2 px-3 py-2 text-xs font-semibold transition-colors bg-white border rounded-lg shadow-sm border-slate-200 hover:border-blue-400 hover:text-blue-600"
                  >
                    <span
                      className="inline-flex items-center px-2 py-1 rounded-md text-[11px] font-semibold border"
                      style={{
                        backgroundColor:
                          statusColorMap[asset?.status_id] || "#E2E8F0",
                        color: statusColorMap[asset?.status_id]
                          ? "#fff"
                          : "#1e293b",
                        borderColor:
                          statusColorMap[asset?.status_id] || "#cbd5e1",
                      }}
                    >
                              ...
                              >
                                <span className="inline-flex items-center gap-2">
                                  <span
                                    ...
                                    style={{
                                      backgroundColor:
                                        statusColorMap[status.id] || "#94a3b8",
                                    }}
                                  />
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-xs font-medium text-white transition-colors bg-blue-600 rounded-lg sm:px-4 sm:text-sm hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={!currentEmployee}
                  className="flex items-center gap-2 px-3 py-2 text-xs font-medium text-white transition-colors bg-orange-600 rounded-lg sm:px-4 sm:text-sm hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-xs font-medium text-white transition-colors bg-indigo-600 rounded-lg sm:px-4 sm:text-sm hover:bg-indigo-700"
                >
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
              ...
              <div className="p-3 border border-purple-200 rounded-lg bg-purple-50 sm:p-4">
              ...
              <div className="p-3 border border-red-200 rounded-lg bg-red-50 sm:p-4">
              ...
              <div className="p-3 border border-indigo-200 rounded-lg bg-indigo-50 sm:p-4">
        ...
        {/* Main Content */}
        <div className="px-4 mx-auto mt-4 max-w-7xl sm:px-6 lg:px-8 sm:mt-6">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 sm:gap-6">
            ...
            <div className="space-y-4 lg:col-span-4 sm:space-y-6">
              ...
              <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
                <h3 className="flex items-center gap-2 mb-4 text-base font-semibold text-gray-900 sm:text-lg">
                  ...
                  <div className="space-y-3">
                      ...
                      <div className="flex-1">
                        ...
                        {currentEmployee.position && (
                          <p className="text-sm text-gray-600">
                            {currentEmployee.position.position_name}
                          </p>
                        )}
                    ...
                    {currentAssignmentDays > 0 && (
                      <div className="pt-3 border-t border-gray-100">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          ...
                          <span>
                            Assigned for{" "}
                            <strong>{currentAssignmentDays} days</strong>
                          </span>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="pt-3 border-t border-gray-100">
                      <button
                        onClick={() =>
                          navigate(
                            `/inventory/employees/${currentEmployee.id}/assets`
                          )
                        }
                        className="flex items-center justify-center w-full gap-2 px-4 py-2 text-sm font-medium text-blue-700 transition-colors rounded-lg bg-blue-50 hover:bg-blue-100"
                      >
                        <Package className="w-4 h-4" />
                        View All {currentEmployee.fullname.split(" ")[0]}'s
                        Assets
                      </button>
                    </div>
                  </div>
              ...
              <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
                ...
                <div className="space-y-3">
                  <div className="flex flex-col gap-1 py-2 border-b border-gray-100 sm:flex-row sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-600">Status</span>
                    <span className="font-medium text-gray-900">
                      {currentStatus?.name || "N/A"}
                    </span>
                  </div>
                  <div className="flex flex-col gap-1 py-2 border-b border-gray-100 sm:flex-row sm:items-center sm:justify-between">
  ...
  return (
    <div className="pb-6 space-y-6 sm:pb-0">
      ...
      {remarksModal &&
        createPortal(
          ...
          >
            <div
              className="w-full max-w-2xl overflow-hidden transition-all duration-200 bg-white shadow-2xl rounded-xl"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Header */}
                ...
                <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm min-h-[120px]">
                  {remarksModal.remarks ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-8 text-slate-400">
                      ...
                      <p className="text-sm">
                        No remarks available for this asset
                      </p>
                    </div>
                  )}
                </div>
      ...
      <div className="flex items-center justify-between mb-4 md:mb-0">
        <button
          onClick={() => navigate("/inventory/assets")}
          className="flex items-center gap-2 transition-colors text-slate-600 hover:text-slate-900 touch-manipulation"
        >
          <ArrowLeft className="w-5 h-5" />
          <span className="hidden font-medium sm:inline">Back to Assets</span>
      ...
      <div className="mt-6 sm:mt-8">
        <div className="p-4 bg-white border rounded-lg shadow-sm border-slate-200 sm:p-6">
          {/* Main Tabs - Assets vs History */}
          <div className="flex items-center gap-1 mb-6 overflow-x-auto border-b sm:gap-2 border-slate-200">
            <button
            ...
            <>
              {employeeAssets.length > 0 ? (
                <>
                  ...
                  <div className="items-center hidden gap-1 mb-6 overflow-x-auto border-b sm:flex sm:gap-2 border-slate-200">
                    <button
                  ...
                  {viewMode === "cards" && selectedAssets && (
                    <div className="flex items-center justify-between p-3 mb-4 border rounded-lg bg-slate-50 border-slate-200">
                      <div className="flex items-center gap-3">
                        <input
                          type="checkbox"
                          checked={
                            selectedAssets.length === employeeAssets?.length &&
                            employeeAssets?.length > 0
                          }
                          onChange={() => handleSelectAll(employeeAssets)}
                          className="w-5 h-5 text-blue-600 border-2 rounded cursor-pointer border-slate-300 focus:ring-2 focus:ring-blue-500"
                        />
                  ...
                  {viewMode === "cards" && (
                    <AssetCardsView
                      ...
                      onQuickStatusChange={(assetId, statusId) =>
                        handleQuickStatusChange(assetId, statusId)
                      }
                      onStatusPickerToggle={(assetId) =>
                        setStatusPickerFor(
                      ...
                      onCodeToggle={(assetId, type) =>
                        setShowCodesFor((prev) => ({
                          ...prev,
      ...
      {isBulkTransferModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
          <div
            className="flex flex-col w-full max-w-lg bg-white rounded-lg shadow-xl"
            style={{ maxHeight: "500px" }}
          >
            <div className="px-6 py-4 border-b border-slate-200">
              <h3 className="text-xl font-semibold text-slate-900">
                Transfer {selectedAssets.length} Asset
                {selectedAssets.length > 1 ? "s" : ""}
              </h3>
            </div>
            <div className="flex-1 p-6">
              <p className="mb-4 text-sm text-slate-600">
                Search and select an employee to transfer the selected assets
                to:
              </p>
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full py-3 pl-10 pr-4 text-sm border rounded-lg border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                  ...
                  <div className="absolute z-[100] w-full mt-1 bg-white border border-slate-300 rounded-lg shadow-xl max-h-60 overflow-y-auto">
                    {isLoadingEmployees ? (
                      <div className="p-4 text-center text-slate-500">
                        <div className="w-6 h-6 mx-auto mb-2 border-blue-600 rounded-full animate-spin border-3 border-t-transparent"></div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange("asset_category_id", e.target.value)
                      }
                      className="w-full px-3 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      required
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("acq_cost", e.target.value)
                      }
                      className="w-full px-3 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder="0.00"
                      step="0.01"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("estimate_life", e.target.value)
                      }
                      className="w-full px-3 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      placeholder="Years"
                      min="0"
...
function InfoCard({ label, value, icon }) {
  ...
  return (
    <div className="p-3 transition-colors border rounded-lg bg-gradient-to-br from-slate-50 to-slate-100 border-slate-200 hover:border-blue-300">
