...
function AssetCategoryPage() {
  ...
  const handleCreate = async (e) => {
    e.preventDefault()
    try {
      const response = await apiClient.post('/asset-categories', formData)
      if (response.data.success) {
        Swal.fire({
          icon: 'success',
          title: 'Success',
  ...
  const handleUpdate = async (e) => {
    e.preventDefault()
    try {
      const response = await apiClient.put(`/asset-categories/${selectedCategory.id}`, formData)
      if (response.data.success) {
        Swal.fire({
          icon: 'success',
          title: 'Success',
  ...
  const handleDelete = useCallback(async (category) => {
    ...
    if (result.isConfirmed) {
      try {
        const response = await apiClient.delete(`/asset-categories/${category.id}`)
        if (response.data.success) {
          Swal.fire({
            icon: 'success',
            title: 'Deleted!',
