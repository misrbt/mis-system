    ...
    <div className="w-full">
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-slate-200 p-5 sm:p-8">
        ...
        <div className="text-center mb-5 sm:mb-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-slate-800">Sign In</h2>
          <p className="text-slate-500 text-xs sm:text-sm mt-1">Sign in to your account to continue</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-9 sm:pl-10 pr-3 py-2.5 sm:py-3 text-sm sm:text-base bg-slate-50 border ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-9 sm:pl-10 pr-9 sm:pr-10 py-2.5 sm:py-3 text-sm sm:text-base bg-slate-50 border ${
